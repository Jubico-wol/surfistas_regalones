...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="../assets/css/participando.css">
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <img src="../assets/img/surf/title.png" alt="">
                                <div class="center">
                                <img src="../assets/img/surf/check.png" alt="">
                                    <h1 class="white font-w900"> YA ESTÁS <br> PARTICIPANDO </h1>
                                </div>
                                <br>
                                <div class="container">
                                    <div class="row padding center">
                                        <h4 class="blue">No. de factura y fotografía ingresado correctamente</h4>
                                    </div>
                                </div>
                        </div>
                    </div>
